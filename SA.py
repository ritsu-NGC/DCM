...
def dis_cal_16bit(placement):# 函数优化问题
    # print("new placement:",placement)
    r2 = open("test_new.txt", "r")
    tol_dis = 0
    # w = open("Mnew_cir.txt", "w")
    for line in r2.readlines():
        ...
        if gate[0] == "CNOT":
            ...
            tar = gate[2].strip("q")
            # print(con,tar)
            tol_dis = tol_dis + distance_cal_16bit(con,tar)
            # print(tol_dis)
    ...
    def run_16bit(self):
        ...
        while self.T > self.Tf:
            ...
            for i in range(self.iter):
                count += 1
                # print(count)
                change_x_y = self.generate_new(16)
                # print(change_x_y)
                # 产生扰乱 修改量子点列中的两个位置
                # print("start:",self.start_res,self.start_place)
                place_new = self.start_place
                ...
                place_new[change_x_y[1]] = tool
                # print("new placement:",place_new)
                result = dis_cal_16bit(place_new)
                # print("计算：",dis_cal(place_new))
                # print("结果：",result)
                f_new = result[0]
                if self.Metrospolis(self.start_res, f_new):# 判断是否接受新值
...
if __name__ == '__main__':
    ...
    sa = SA(['q6', 'q1', 'q13', 'q10', 'q9', 'q12', 'q15', 'q2', 'q4', 'q5', 'q14', 'q0', 'q11', 'q8', 'q7', 'q3'],9)
    print("结果：",GetMin(sa.run_16bit()))
    # for item in sa.run():
    #     print("结果：",item)
    ...
    # print(dis_cal_16bit( ['q6', 'q1', 'q13', 'q10', 'q9', 'q12', 'q15', 'q2', 'q4', 'q5', 'q14', 'q0', 'q11', 'q8', 'q7', 'q3']))
